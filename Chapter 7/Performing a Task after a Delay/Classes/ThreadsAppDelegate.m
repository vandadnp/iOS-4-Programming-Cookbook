...
- (void) connectionHasFailedWithError:(NSError *)paramError 
                          onRemoteURL:(NSURL *)paramRemoteURL{
  
  /* We failed to download the file. Attempt to download it again
   after 3 seconds */
  
  [self performSelector:@selector(attemptToDownloadRemoteURL:)
             withObject:paramRemoteURL
             afterDelay:3.0f];
